...
# >> After looking at histogram, add this in Word:
# The distribution is approximately bell-shaped but slightly right-skewed.
# Most delivery times are between 35–55 minutes, with fewer long deliveries.
